                    ...
                    <div class="col-lg-6">
                        <div class="p-5">
                            <div class="text-inline">
                                ...
                                <h1 class="h4 text-gray-900 mb-2">Semester: {{auth()->user()->subscribe->semester->year ?? null}} _ {{auth()->user()->subscribe->semester->semester_no ?? null}}</h1>
                                <h1 class="h4 text-darke mb-2">Change Password</h1>
                                <form action="{{route('student.changepassword')}}" method="post" class="user">
                                    @csrf
